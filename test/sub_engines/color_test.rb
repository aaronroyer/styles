...
class ColorSubEngineTest < MiniTest::Unit::TestCase
  ...
  def test_can_combine_line_and_match_properties
    ...
    assert_equal "#{color.on_blue}this line has a certain #{color.reset}#{color.green}word#{color.reset}#{color.on_blue} in it#{color.reset}",
  ...
  def test_can_combine_line_and_match_properties_with_multiple_matches
    ...
    color_prop = ::Styles::Properties::BackgroundColor.new(:blue, 'line')
    ...
    assert_equal "#{color.on_blue}this line has the #{color.reset}#{color.green}number#{color.reset}#{color.on_blue}" +
      " 12 and the #{color.reset}#{color.green}number#{color.reset}#{color.on_blue} 89 in it#{color.reset}",
      sub_engine.process([color_prop, string_match_color_prop], test_line)

    assert_equal "#{color.on_blue}this line has the number #{color.reset}#{color.green}12#{color.reset}#{color.on_blue}" +
      " and the number #{color.reset}#{color.green}89#{color.reset}#{color.on_blue} in it#{color.reset}",
      sub_engine.process([color_prop, regex_match_color_prop], test_line)
  end
  ...
  def test_can_combine_line_and_match_properties_with_multiple_match_colors
    ...
    assert_equal "#{color.on_blue}this line has the #{color.reset}#{color.green}number#{color.reset}#{color.on_blue}" +
      " #{color.reset}#{color.red}12#{color.reset}#{color.on_blue} in it#{color.reset}",
      sub_engine.process([color_prop, regex_match_color_prop], test_line)
  end
